    ...
    checklists: [
      {
        ...
        name: 'PARKING',
        items: [
          { id: 'pk-1', item: 'Gears', value: 'N', completed: false, required: true },
          { id: 'pk-2', item: 'Parking brake', value: 'Set', completed: false, required: true },
          { id: 'pk-3', item: 'Roof', value: 'CLOSED & LOCKED', completed: false, required: true },
          { id: 'pk-4', item: 'Doors', value: 'UNLOCKED', completed: false, required: true },
          { id: 'pk-5', item: 'Windows', value: 'CLOSED', completed: false, required: true },
          { id: 'pk-6', item: 'Seat heaters', value: 'OFF', completed: false, required: true },
          { id: 'pk-7', item: 'Master switch', value: 'CUTOFF', completed: false, required: true },
        ],
      },
    ],
  },
    ...
    checklists: [
      {
        ...
        name: 'ACCIDENT',
        items: [
          { id: 'ac-1', item: 'Call ambulance', value: 'AS REQUIRED', completed: false, required: false },
          { id: 'ac-2', item: 'Call police', value: 'AS REQUIRED', completed: false, required: false },
          { id: 'ac-3', item: 'Call dealer', value: 'AS REQUIRED', completed: false, required: false },
          { id: 'ac-4', item: 'Call insurer', value: 'AS REQUIRED', completed: false, required: false },
        ],
      },
    ],
  },
